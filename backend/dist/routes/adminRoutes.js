...
router.get('/chats/unread-counts', auth_1.default, role_1.adminRoleMiddleware, AdminChatController_1.default.getUnreadCounts);
router.post('/chats/user/:userId/mark-read', auth_1.default, role_1.adminRoleMiddleware, validateUserId_1.validateUserId, AdminChatController_1.default.markMessagesAsRead);
router.post('/payment-request', auth_1.default, PaymentController_1.default.createPaymentRequest);
router.get('/payment-requests', auth_1.default, PaymentController_1.default.getAdminPaymentRequests);
